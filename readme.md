...
## Deliverables
 - Protocols and packages for academic degrees and portfolio management system.
 - This Hackasson is developing on the premise of operation at the university.
...
## Concept of identity
 - Authentication information is aggregated into one identity
 - Users can use them separately for different purposes

## Our goals
 - Technical implementation is surely done
 - Issues on operational aspects are being considered appropriately
 - Considered legal compliance such as GDPR
...
### Data Storage (IPFS) and Encryption
https://github.com/block-base/blockchain_hk2019tokyo_demo/tree/master/sample/ipfs

## Planned Schedule and Roles
### 2/16
#### 9:00-12:00
 - Yamamura: Legal compliance such as GDPR
 - Marimo：Design and Operation arrangement at university
 - Tanaka：IPFS function verification
 - Sanagi：Function verification of Smart Contract
...
#### 16:00-18:00
 - Investigation of operational issues and countermeasures
 - Sketch of presentation slides
...
## Actual schedule
 - It took more time than expected to support v2 update of ERC 725
 - It took a long time to verify the logic that encrypted with the public key of the Ethereum Wallet and restored with the secret key
